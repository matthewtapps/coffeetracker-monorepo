...
export function DataTable<TData, TValue>({
    ...
    const [columnsMenuVisibility, setColumnsMenuVisibility] = React.useState(false)
    ...
    return (
        <div>
            <div className="flex items-center m-4">
                ...
                />
                <DropdownMenu open={columnsMenuVisibility} onOpenChange={() => setColumnsMenuVisibility(!columnsMenuVisibility)}>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="ml-auto" onClick={() => setColumnsMenuVisibility(!columnsMenuVisibility)} disabled={!isDesktop}>
                            Columns
                        </Button>
                    </DropdownMenuTrigger>
